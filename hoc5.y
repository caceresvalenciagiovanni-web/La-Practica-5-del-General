...
%token <sym> NUMBER VAR BLTIN INDEF WHILE IF ELSE PRINT
...
int main(int argc, char **argv) {
    progname = argv[0];
    printf("---------------------------------------------------------------------------\n");
    printf("                           LENGUAJE VECTORIAL HOC5\n");
    printf("---------------------------------------------------------------------------\n");
    printf("Soporte Vectores: [1, 2, 3] | Suma(+) Resta(-) Prod.Cruz(X) Punto(@)\n");
    printf("Soporte Turing: if (cond) { ... } else { ... } | while (cond) { ... }\n");
    printf("---------------------------------------------------------------------------\n");
